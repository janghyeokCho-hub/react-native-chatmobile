...
export default function ForwardIcon({ ...rest }) {
    return (
        <Svg x="0px" y="0px" width="16.294px" height="16.88px" viewBox="0 0 512.035 512.035" style="enable-background:new 0 0 512.035 512.035;" {...rest}>
            <G>
			...
			L29.048,17.084h223.573l238.933,238.933L252.621,494.951z" fill="#555" />
            </G>
        </Svg>
