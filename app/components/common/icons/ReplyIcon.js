...
export default function ReplyIcon({ replyAll = false, ...rest }) {
    return (
        <Svg x="0px" y="0px" width="20.294px" height="20.88px" viewBox="0 0 511.971 511.971" { ...rest }>
            <G>
                <Path d="M444.771,235.493c-58.987-56.32-138.347-64-167.467-64.747V96.079c0-5.867-4.8-10.667-10.667-10.667
                    ...
                    c32.107,30.72,51.52,72.32,58.027,124.16C436.665,305.679,371.171,290.533,324.131,290.533z" fill="#555" />
                ...
                {replyAll && (
                    <Path d="M199.331,387.066c-0.213-0.107-0.32-0.32-0.533-0.427L27.385,245.413l171.413-141.12
                        ...
                        C204.131,397.626,203.705,390.906,199.331,387.066z" fill="#555"/>
                )}
            </G>
        </Svg>
    );
